...
'aB'$$*-1|$$$*-1=='Ab'; Нужно будет выбрать один из вариантов в будущем
'aB'$$*-2|$$$*-2=='ab';
'aB'$$*2|$$*--2$$$*2=='AB';
### Функции  
...
abc=>
-> - return. В c/c++/c# указывает на структуры

### Буквенные выражения
#### stdio:
console.in - ввод в консоль
console.out - вывод из консоли
...
'ABA'$$[:-1]==3; Еще один способ вычисления количества элементов
'ABA'/'CDS'=='ACBDAS';  
